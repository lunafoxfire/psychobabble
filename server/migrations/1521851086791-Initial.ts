...
export class Initial1521851086791 implements MigrationInterface {

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query(`CREATE TABLE "roles" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, PRIMARY KEY("id"))`);
        await queryRunner.query(`CREATE TABLE "responses" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "audio_gs_path" character varying, "text_version" character varying, "score" integer, "reviewed" boolean NOT NULL, "subjectId" uuid, "videoId" uuid, "programId" uuid, PRIMARY KEY("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "videos_soft_skills_soft_skills" ("videosId" uuid NOT NULL, "softSkillsId" integer NOT NULL, PRIMARY KEY("videosId", "softSkillsId"))`);
        ...
        await queryRunner.query(`ALTER TABLE "videos_soft_skills_soft_skills" ADD CONSTRAINT "fk_dff6549ceb1525a0eec5896b481" FOREIGN KEY ("videosId") REFERENCES "videos"("id")`);
        await queryRunner.query(`ALTER TABLE "videos_soft_skills_soft_skills" ADD CONSTRAINT "fk_2ab9cf48d47d8f266f5155f5a19" FOREIGN KEY ("softSkillsId") REFERENCES "soft_skills"("id")`);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`ALTER TABLE "videos_soft_skills_soft_skills" DROP CONSTRAINT "fk_2ab9cf48d47d8f266f5155f5a19"`);
        await queryRunner.query(`ALTER TABLE "videos_soft_skills_soft_skills" DROP CONSTRAINT "fk_dff6549ceb1525a0eec5896b481"`);
        ...
        await queryRunner.query(`DROP TABLE "videos_soft_skills_soft_skills"`);
